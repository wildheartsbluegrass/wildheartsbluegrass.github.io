...
document.addEventListener('DOMContentLoaded', function () {
   ...
   // =====================
   // Audio Player - Multiple Players Support
   // =====================
   
   function initAudioPlayer(playerNum) {
      ...
      const progress = document.getElementById('progress' + playerNum);
      ...
      const volumeSlider = document.getElementById('volumeSlider' + playerNum);
      const visualizer = document.getElementById('visualizer' + playerNum);

      if (!audio || !playBtn) return; // Skip if elements don't exist
      ...
      audio.addEventListener('canplay', function () {
         console.log('Audio ' + playerNum + ' ready to play, duration:', audio.duration);
         audioDuration = audio.duration;
         durationEl.textContent = formatTime(audioDuration);
      });
   }
